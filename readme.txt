...
This WooCommerce extension automatically adds a PDF or XML invoice (e-invoicing) to the order confirmation emails sent out to your customers. Includes a basic template as well as the possibility to modify/create your own templates. In addition, you can choose to download or print invoices and packing slips from the WooCommerce order admin.
...
You can create your own custom templates by copying the included Simple template to your theme folder and modifying it to match your needs. The plugin supports full HTML/CSS customization of invoice templates.
